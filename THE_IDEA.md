...
- Using Logitech cams and Google Home Mini
- AI companion
...
- As they walk, they can talk, as they talk to themselves, but the audio is being captured by Google Home, which will be configured to use Gemini API.
